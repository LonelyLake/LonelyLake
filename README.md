...
- **Current Role:** AI Engineering Intern @ Łukasiewicz – AI
...
- Built a local **Medallion Architecture** organizing raw API snapshots into sanitized, type-safe Parquet files.
- Implemented **exponential backoff retries** for API ingestion and schema validation for environmental anomaly filtering.
- Ensured **idempotent batch loading** into PostgreSQL and authored SQL analytical queries (WHO exceedances).
- *Tech:* `Python`, `Pandas`, `PostgreSQL`, `Parquet`, `Docker`
...
- *Tech:* `DuckDB`, `SQL (DDL/DML/MERGE)`, `Data Modeling`
